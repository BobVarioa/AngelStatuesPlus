...
namespace AngelMod.Items
{
    public class AngelTokenTier7 : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("An emblem forged from technology beyond our time.");
        }
    ...
    public class OfferAngelTokenTier7 : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            TooltipLine tooltipLine = new TooltipLine(mod, "1", $"Sacrifced {player.AngelTokensSacrifced7} Token" + (player.AngelTokensSacrifced7 != 1 ? "s" : "") + "");
