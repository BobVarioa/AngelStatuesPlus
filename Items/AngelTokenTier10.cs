...
namespace AngelMod.Items
{
    public class AngelTokenTier10 : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("An emblem of lunatic energies.");
        }
    ...
    public class OfferAngelTokenTier10 : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            TooltipLine tooltipLine = new TooltipLine(mod, "1", $"Sacrifced {player.AngelTokensSacrifced10} Token" + (player.AngelTokensSacrifced10 != 1 ? "s" : "") + "");
